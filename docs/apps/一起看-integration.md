...
> 本文档面向"一起看"业务方的开发者（人或 AI 助手均可直接按此落地）。
...
const APP_ID = "app_f2ce7d84dec8ad56";
...
await moderate("avatar", "user-5678", "https://cdn.example.com/avatars/u5678.jpg", {
  mode: "auto",
  callback_url: "https://api.yiqikan.com/hooks/moderation",
  user_id: "u5678",
...
```javascript
await moderate("avatar", "u42", "https://cdn.yiqikan.com/u42.jpg", {
  user_id: "u42",
  callback_url: "https://api.yiqikan.com/hooks/moderation",
  extra: { ts: Date.now() },
});
...
> 如果一起看的头像 CDN 有防盗链或鉴权，请确保**公网可直接 GET**。平台会从 CF Workers 边缘拉图。
