...
export const AD_RULES: AdRule[] = [
  ...
  // 汉字数字写出的联系方式（规避正则的常见手法）：
  //   黑话锚点（扣/企鹅/微信/v/电报/加…）+ 分隔符 + 一长串中文数字 = 拼出来的 QQ/手机号
  //   gate 在「≥6 连续中文数字字」——正常聊天极少出现这么长的中文数字串，FP 很低
  {
    name: "cn_numeral_contact",
    re: /(扣|抠|企鹅|\u{1F427}|微信?|威信?|[vV][xX]|电报|tg|TG|telegram|Telegram)[\s。.，,、:：的是]{0,4}[〇零幺一二两三四五六七八九十百千万亿]{6,}/u,
  },
